...
/// RF pins.
#define nrf24l01plus_MISO {1 << 16, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}
...
#define nrf24l01plus_CE {1<<4, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define nrf24l01plus_CSN {1 << 12, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}


#define TX_ADR_WIDTH    5   // 5 unsigned chars TX(RX) address width
#define TX_PLOAD_WIDTH  32  // 32 unsigned chars TX payload

xQueueHandle xRadioRX_Queue;		/* Create a RX Queue */
xQueueHandle xRadioTX_Queue;		/* Create a TX Queue */
