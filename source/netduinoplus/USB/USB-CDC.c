...
void vUSBSendByte( unsigned char cByte )
{
...
unsigned char ucUSBReadByte( void)
{
	unsigned char cByte;
...
extern void ( vUSB_ISR_Wrapper )( void );
	...
	AT91C_BASE_PMC->PMC_PCER = (1 << AT91C_ID_UDP) | (1 << AT91C_ID_PIOA) | (1 << AT91C_ID_PIOB) | (1 << AT91C_ID_EMAC) | (1 << AT91C_ID_SPI0) | (1 << AT91C_ID_SPI1);
